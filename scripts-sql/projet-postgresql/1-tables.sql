...
CREATE TABLE type_benevole (
	id_type_benevole	INT				GENERATED BY DEFAULT AS IDENTITY,
	nom_type_benevole 	VARCHAR(50)		NOT NULL,	
	PRIMARY KEY (id_type_benevole)
);
...
CREATE TABLE benevole (
	...
	FOREIGN KEY (id_type_benevole) REFERENCES type_benevole (id_type_benevole)
);
